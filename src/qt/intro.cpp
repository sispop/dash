    ...
    m_chain_state_size(chain_state_size)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Syspop block chain.").arg(PACKAGE_NAME) + " " +
...
bool Intro::pickDataDirectory(interfaces::Node& node)
{
     ...
     * override -datadir in the syspop.conf file in the default data directory
     * (to be consistent with syspopd behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
