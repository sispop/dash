...
/* SyspopGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* SyspopGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Syspop"
#define QAPP_ORG_DOMAIN "syspop.tech"
#define QAPP_APP_NAME_DEFAULT "Syspop-Qt"
#define QAPP_APP_NAME_TESTNET "Syspop-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Syspop-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Syspop-Qt-regtest"
