...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Syspop address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Syspop address").arg(strCoinJoinName));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Syspop addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Syspop addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Syspop command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Syspop network", "", count));
    } else {
