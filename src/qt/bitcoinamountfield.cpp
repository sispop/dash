...
public:
    explicit AmountValidator(QObject *parent) :
        QValidator(parent),
        currentUnit(BitcoinUnits::SYSPOP) {}
...
public:
    ...
    QSize minimumSizeHint() const override
    {
        ...
        int h = 0;
        int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::SYSPOP, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    int currentUnit{BitcoinUnits::SYSPOP};
