...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    "as change, and not show up in many RPCs.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Syspop address (or hex-encoded script)"},
...

    {
        ...
        if (IsValidDestination(dest)) {
            ...
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Syspop address or script");
        }
    }
    if (fRescan)
    {
...
UniValue dumpprivkey(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpprivkey",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The syspop address for the private key"},
        },
        RPCResult{
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpwallet",
        ...
        {
            {"filename", RPCArg::Type::STR, RPCArg::Optional::NO, "The filename with path (either absolute or relative to syspopd)"},
        },
        RPCResult{
                RPCResult::Type::OBJ, "", "",
                {
    ...
    // produce output
    file << strprintf("# Wallet dump created by Syspop Core %s\n", CLIENT_BUILD);
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("syspopcoreversion", CLIENT_BUILD);
                    ...
                    result.pushKV(
                        ...
                        JSONRPCError(
                            ...
                            strprintf("Rescan failed for key with creation timestamp %d. There was an error reading a "
                                      ...
                                      "caused by pruning or data corruption (see syspopd log for details) and could "
