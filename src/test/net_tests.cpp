...
BOOST_AUTO_TEST_CASE(caddrdb_read)
{
    ...
    BOOST_CHECK(Lookup("250.7.2.2", addr2, 19999, false));
    BOOST_CHECK(Lookup("250.7.3.3", addr3, 19999, false));
    BOOST_CHECK(Lookup(std::string("250.7.3.3", 9), addr3, 19999, false));
    BOOST_CHECK(!Lookup(std::string("250.7.3.3\0example.com", 21), addr3, 19999, false));
